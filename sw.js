const CACHE = 'hao-shell-v9';
const SHELL = ['./', './index.html', './styles.css', './app.js', './auth-session.js', './voice.js', './role-voice.js', './audio-capture.js', './audio-worklet.js', './conversation.js', './privacy.js', './config.js', './assets/app-icon.png'];
