const CACHE = 'hao-shell-v13-mic-recovery';
const SHELL = ['./', './index.html', './styles.css', './app.js?v=20260918-voice3', './auth-session.js', './voice.js?v=20260918-voice3', './role-voice.js', './audio-capture.js', './audio-worklet.js', './conversation.js?v=20260918-voice3', './model-default.js?v=20260918-voice3', './privacy.js', './config.js', './assets/app-icon.png'];
